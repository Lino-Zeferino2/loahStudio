  ...
  Widget _buildProdutoCard(Map<String, dynamic> produto) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 8),
        Row(children: [Transform.scale(scale: 0.8, child: Switch(value: disponivel, onChanged: (v) => _toggleDisponibilidade(produto, v), activeThumbColor: Colors.green, inactiveThumbColor: Colors.red)), const Spacer(), IconButton(onPressed: () => _showEditarDialog(produto), icon: const Icon(Icons.edit, size: 18), color: AppColors.pinkStrong, padding: EdgeInsets.zero, constraints: const BoxConstraints()), IconButton(onPressed: () => _showExcluirDialog(produto), icon: const Icon(Icons.delete, size: 18), color: Colors.red, padding: EdgeInsets.zero, constraints: const BoxConstraints())]),
      ]),
    );
  }
